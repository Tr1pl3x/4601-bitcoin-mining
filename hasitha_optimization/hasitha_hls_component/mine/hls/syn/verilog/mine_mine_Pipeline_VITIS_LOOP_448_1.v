...
module mine_mine_Pipeline_VITIS_LOOP_448_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln448_reg_209;
reg   [0:0] icmp_ln450_reg_213;
reg    ap_predicate_op24_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln448_fu_120_p2;
...
reg   [4:0] i_4_reg_204;
reg   [4:0] i_4_reg_204_pp0_iter1_reg;
reg   [0:0] icmp_ln448_reg_209_pp0_iter1_reg;
wire   [0:0] icmp_ln450_fu_136_p2;
reg   [0:0] icmp_ln450_reg_213_pp0_iter1_reg;
reg   [127:0] gmem0_addr_read_reg_217;
reg   [127:0] ap_phi_mux_empty_phi_fu_97_p4;
wire   [127:0] ap_phi_reg_pp0_iter2_empty_reg_94;
wire   [127:0] zext_ln448_fu_156_p1;
wire   [63:0] zext_ln448_1_fu_161_p1;
reg   [95:0] shiftreg6_fu_62;
wire    ap_loop_init;
reg   [4:0] i_fu_66;
wire   [4:0] add_ln448_fu_126_p2;
reg   [4:0] ap_sig_allocacmp_i_4;
reg    hdr_we0_local;
wire   [31:0] trunc_ln450_fu_165_p1;
reg    hdr_ce0_local;
wire   [1:0] trunc_ln448_fu_132_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln448_fu_120_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            shiftreg6_fu_62 <= 96'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            shiftreg6_fu_62 <= {{ap_phi_mux_empty_phi_fu_97_p4[127:32]}};
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln448_fu_120_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((icmp_ln448_reg_209_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln450_reg_213_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_phi_fu_97_p4 = zext_ln448_fu_156_p1;
        end else if ((icmp_ln450_reg_213_pp0_iter1_reg == 1'd1)) begin
...
assign add_ln448_fu_126_p2 = (ap_sig_allocacmp_i_4 + 5'd1);
...
always @ (*) begin
    ap_predicate_op24_read_state2 = ((icmp_ln450_reg_213 == 1'd1) & (icmp_ln448_reg_209 == 1'd0));
end

assign ap_ready = ap_ready_sig;

assign hdr_address0 = zext_ln448_1_fu_161_p1;

assign hdr_ce0 = hdr_ce0_local;

assign hdr_d0 = trunc_ln450_fu_165_p1;

assign hdr_we0 = hdr_we0_local;

assign icmp_ln448_fu_120_p2 = ((ap_sig_allocacmp_i_4 == 5'd20) ? 1'b1 : 1'b0);

assign icmp_ln450_fu_136_p2 = ((trunc_ln448_fu_132_p1 == 2'd0) ? 1'b1 : 1'b0);
...
assign trunc_ln448_fu_132_p1 = ap_sig_allocacmp_i_4[1:0];

assign trunc_ln450_fu_165_p1 = ap_phi_mux_empty_phi_fu_97_p4[31:0];

assign zext_ln448_1_fu_161_p1 = i_4_reg_204_pp0_iter1_reg;

assign zext_ln448_fu_156_p1 = shiftreg6_fu_62;

endmodule //mine_mine_Pipeline_VITIS_LOOP_448_1
