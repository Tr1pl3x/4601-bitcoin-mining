...
set C_modelArgList {
	...
	{ header int 64 regular {axi_slave 0}  }
	{ target int 64 regular {axi_slave 0}  }
	{ nonce_start int 32 regular {axi_slave 0}  }
	{ nonce_count int 32 regular {axi_slave 0}  }
	{ found_nonce int 64 regular {axi_slave 0}  }
	{ found int 64 regular {axi_slave 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "header","offset": { "type": "dynamic","port_name": "header","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "target","offset": { "type": "dynamic","port_name": "target","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "found_nonce","offset": { "type": "dynamic","port_name": "found_nonce","bundle": "control"},"direction": "WRITEONLY"},{"cName": "found","offset": { "type": "dynamic","port_name": "found","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "header", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "target", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "nonce_start", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "nonce_count", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":48}, "offset_end" : {"in":55}} , 
 	{ "Name" : "found_nonce", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":56}, "offset_end" : {"in":67}} , 
 	{ "Name" : "found", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":68}, "offset_end" : {"in":79}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"mine","role":"start","value":"0","valid_bit":"0"},{"name":"mine","role":"continue","value":"0","valid_bit":"4"},{"name":"mine","role":"auto_start","value":"0","valid_bit":"7"},{"name":"header","role":"data","value":"16"},{"name":"target","role":"data","value":"28"},{"name":"nonce_start","role":"data","value":"40"},{"name":"nonce_count","role":"data","value":"48"},{"name":"found_nonce","role":"data","value":"56"},{"name":"found","role":"data","value":"68"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"mine","role":"start","value":"0","valid_bit":"0"},{"name":"mine","role":"done","value":"0","valid_bit":"1"},{"name":"mine","role":"idle","value":"0","valid_bit":"2"},{"name":"mine","role":"ready","value":"0","valid_bit":"3"},{"name":"mine","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	mine {
		...
		gmem2 {Type O LastRead 87 FirstWrite 85}
		header {Type I LastRead 0 FirstWrite -1}
		target {Type I LastRead 0 FirstWrite -1}
		nonce_start {Type I LastRead 78 FirstWrite -1}
		nonce_count {Type I LastRead 78 FirstWrite -1}
		found_nonce {Type I LastRead 0 FirstWrite -1}
		found {Type I LastRead 0 FirstWrite -1}
		K {Type I LastRead -1 FirstWrite -1}}
	mine_Pipeline_VITIS_LOOP_448_1 {
		gmem0 {Type I LastRead 1 FirstWrite -1}
		hdr {Type O LastRead -1 FirstWrite 2}
