set moduleName mine_Pipeline_VITIS_LOOP_448_1
set isTopModule 0
...
set cdfgNum 14
set C_modelName {mine_Pipeline_VITIS_LOOP_448_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict hdr { MEM_WIDTH 32 MEM_SIZE 80 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 128 regular {axi_master 0}  }
	{ hdr int 32 regular {array 20 { 0 3 } 0 1 }  }
	{ sext_ln448 int 60 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "header","offset": { "type": "dynamic","port_name": "header","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "hdr", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln448", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ hdr_address0 sc_out sc_lv 5 signal 1 } 
	{ hdr_ce0 sc_out sc_logic 1 signal 1 } 
	{ hdr_we0 sc_out sc_logic 1 signal 1 } 
	{ hdr_d0 sc_out sc_lv 32 signal 1 } 
	{ sext_ln448 sc_in sc_lv 60 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "hdr_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "hdr", "role": "we0" }} , 
 	{ "name": "hdr_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "hdr", "role": "d0" }} , 
 	{ "name": "sext_ln448", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln448", "role": "default" }}  ]}
